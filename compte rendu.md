...
ant d'autres variables pourrait renforcer la robustesse et la généralisabilité des modèles.
"""
...
Ce rapport présente une analyse approfondie d’un jeu de données portant sur l’impact de l’utilisation des réseaux sociaux sur la santé mentale, provenant de Kaggle. L’objectif principal est d’examiner comment différents comportements numériques — tels que le temps d’écran, le temps passé sur les réseaux sociaux, l’estime de soi, l’anxiété, la qualité du sommeil ou la productivité — influencent des indicateurs psychologiques clés, notamment l’indice de bonheur.

Le projet consiste également à construire et comparer plusieurs modèles de régression visant à prédire le Happiness Index (1–10) à partir de ces variables comportementales et psychologiques. Cette approche permet d’évaluer quels facteurs contribuent le plus au bien‑être perçu et d’identifier les relations significatives entre habitudes numériques et santé mentale.
